...
public class Gameplay extends JPanel implements KeyListener , ActionListener{
	...
	public void paint(Graphics g)//draw all the thing in panel
	{
		if(moves==0)// first time in start the game
		{
			snakexlength[2]=50;
			snakexlength[1]=75;
			snakexlength[0]=100;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(right) 
		{
			...
			repaint();//it will call paint automatically again and execute
		}
		if(left) 
		{
			for(int r=lengthofsnake-1;r>=0;r--)
			...
			repaint();//it will call paint automatically again
		}
		if(up) 
		{
			for(int r=lengthofsnake-1;r>=0;r--)
